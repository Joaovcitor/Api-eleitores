...
module.exports = class DemandaController {
  ...
  static async show(req, res) {
    ...
    try {
      ...
      if (!demanda) {
        return res
          .status(404)
          .json({ errors: "Não existe demanda com esse ID." });
      }
  ...
  static async store(req, res) {
    ...
    try {
      ...
      res
        .status(500)
        .json({ errors: "Ocorreu um erro desconhecido ao criar a demanda." });
    }
  }
  ...
  static async update(req, res) {
    ...
    try {
      ...
      console.log(e);
      res.status(500).json({
        errors: "Ocorreu um erro desconhecido ao editar essa demanda."
      });
    }
  }
};
